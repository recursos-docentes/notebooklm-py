...
> **Nota (julio de 2026):** Google renombró **NotebookLM** como **[Gemini Notebook](https://blog.google/innovation-and-ai/products/gemini-notebook/notebooklm-gemini-notebook/)**. Sigue siendo el mismo producto independiente (ahora también accesible desde la app de Gemini), los enlaces existentes redirigen automáticamente y esta librería controla el mismo servicio subyacente sin cambios. El paquete conserva el nombre `notebooklm-py`.
 
[![Versión en PyPI](https://img.shields.io/pypi/v/notebooklm-py.svg)](https://pypi.org/project/notebooklm-py/)
[![Versión de Python](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13%20%7C%203.14-blue)](https://pypi.org/project/notebooklm-py/)
...
>
> Ideal para prototipos, investigación y proyectos personales. Consultar [Solución de problemas](docs/troubleshooting.md) para consejos de depuración.
 
## Qué se puede construir
 
🤖 **Herramientas para agentes de IA** - Integra NotebookLM en Claude Code, Codex y otros agentes LLM. Incluye una skill raíz de [NotebookLM](SKILL.md) para GitHub y para el descubrimiento vía `npx skills add`, soporte local mediante `notebooklm skill install` para Claude Code y directorios de skills `.agents`, y una guía a nivel de repositorio para Codex en [`AGENTS.md`](AGENTS.md).
...
La guía de instalación completa — seis perfiles (agente, usuario final, librería, sin interfaz gráfica, colaborador, usuario avanzado), matriz de extras opcionales, notas por plataforma — está en **[docs/installation.md](docs/installation.md)**.
...
Si `playwright install chromium` falla en Linux con `TypeError: onExit is not a function`, ver la [solución alternativa para Linux](docs/troubleshooting.md#linux). **Colaboradores:** ver [CONTRIBUTING.md](CONTRIBUTING.md).
...
Obtiene el [SKILL.md](SKILL.md) canónico directamente desde GitHub.
...
<p align="center">
  ...
  <br>
  <em>Sesión de 16 minutos comprimida a 30 segundos</em>
</p>
### CLI
...
- **[Referencia de la CLI](docs/cli-reference.md)** - Documentación completa de comandos
- **[API de Python](docs/python-api.md)** - Referencia completa de la API
- **[Guía de MCP](docs/mcp-guide.md)** - Configuración del servidor MCP, transportes y referencia de herramientas
- **[Servidor de API REST](docs/installation.md#rest-api-server)** - Servidor FastAPI experimental en localhost
- **[Configuración](docs/configuration.md)** - Almacenamiento y ajustes
- **[Límites de cuota y nivel de cuenta](docs/quota-limits.md)** - Límites de notebooks/fuentes/estudio por nivel de cuenta y cómo se corresponden con `AccountLimits.tier`
- **[Guía de lanzamiento](docs/releasing.md)** - Lista de verificación de lanzamiento y verificación del empaquetado
- **[Solución de problemas](docs/troubleshooting.md)** - Problemas comunes y soluciones
- **[Estabilidad de la API](docs/stability.md)** - Política de versionado y garantías de estabilidad
- **[Actualización a la versión 0.8.0](docs/upgrading-to-0.8.0.md)** - Guía de migración de cambios incompatibles para el contrato de errores y retornos de la v0.8.0
### Para colaboradores
 
- **[Arquitectura](docs/architecture.md)** - Visión general de la arquitectura y principios de diseño
- **[Guía de desarrollo](docs/development.md)** - Arquitectura, pruebas y lanzamientos
- **[Desarrollo de RPC](docs/rpc-development.md)** - Captura y depuración de protocolo
- **[Referencia de RPC](docs/rpc-reference.md)** - Estructuras de payload
- **[Registro de cambios](CHANGELOG.md)** - Historial de versiones y notas de lanzamiento
- **[Seguridad](SECURITY.md)** - Política de seguridad y manejo de credenciales
## Licencia
